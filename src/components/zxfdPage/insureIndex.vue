	...
	<div style="background:#F5F5F5;">
        ...
        <div class="nweInsuranceColumn">
            ...
            <div style="padding-left:.3rem">
                ...
                <div class="insuranceSetBox newWidth" id="setArea_1" style="display:none;">
                ...
                <div class="insuranceSetBox newWidth" id="setArea_2" >
                ...
                <div class="insuranceSetBox_1" id="setPackage_1"  style="display:none;">
                ...
                <div class="insuranceSetBox_1" id="setPackage_2">
