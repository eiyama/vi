<template>
  <div style="background-color:#FFF">
      ...
      <mt-tab-container v-model="selected" class="mint-tab-content">
        <mt-tab-container-item id="1">
          <table class="mint-table" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <th>车辆注册日期</th>
              <td>{{custDetailsData.registerDate.substring(0,10)}}</td>
            </tr>
            <tr>
              <th>是否过户</th>
    ...
    <div class="mint-bottom">
      ...
      <button class="btn-bottom" style="border:1px solid #4A66FE;border-radius:8px;margin-left:10px;height:35px" @click="toTrackRecord">录入跟进结果</button>
      <button class="btn-bottom" style="border:1px solid #4A66FE;border-radius:8px;margin-right:10px;margin-left:10px;height:35px" @click="quote">一键报价</button>
    </div>
