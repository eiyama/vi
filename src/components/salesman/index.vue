  ...
  <div class="home" style="background-color:#F5F5F5">
    ...
    <div style="margin-top:48px;padding-bottom:5px">
      <div class="performanceItem" @click="topersonalIncome">
        <p style="color:#333;font-size:12px;font-weight:600">已付款金额(元)：{{fees.accumulatedIncome}}</p>
        <van-icon name="arrow"></van-icon>
      </div>
      <div style="background: #fff;padding: 15px;  border-bottom: 1px solid #eee;">
        <p>待结算费用(元)：</p>
        <div style="display: flex;justify-content: space-between;align-items: center;margin: 10px 0;">
          <p style="font-size: 24px;color:#333333;font-weight: bold;">{{fees.unSettleFee}}</p>
        ...
        <div style="display:flex;justify-content: space-between;align-items: center;margin: 15px 0;">
          <span>
            <p>待审批费用(元)：</p>
            <p style="font-weight: bold;">{{fees.settleFee}}</p>
          </span>
          <span>
            <p > 已审批待付款费用(元)：</p>
            <p style="font-weight: bold;">{{fees.checkedFee}}</p>
          </span>    
        </div>
      </div>
    </div>
