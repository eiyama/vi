...
import { dialog } from 'vant';
    ...
    methods: {
        ...
        getAmountfun(){
            ...
            axiosPostAPI('PropertyProducts/PAIC-HK-CZWY/QuotedPrice',model).then(res=>{
                if(res.status == 200){
        ...
        toProductMicro(){
            ...
            updataModel.Properties.PayReturnUrl = url + '/pingan/storeTreasure?appId=' + localStorage.getItem('appId') + '&ProductCode=PAIC-HK-DJB';
