      ...
      <div class="bottom-tab">
        <div class="bottom-nav">
          ...
          <div class="buttom-item" :class="{ 'cur': bottomNav=='home'}" value="home" @click="handleChange">
            <div class="item-wrapper"><i class="icon-icon-home"></i>报价</div>
          </div>
          ...
          <div class="buttom-item" :class="{ 'cur': bottomNav=='quotationList'}" value="quotationList" @click="handleChange">
            <div class="item-wrapper"><i class="icon-icon-orders"></i>投保单</div>
          </div>       
          <div v-if="showStatement" class="buttom-item" :class="{ 'cur': bottomNav=='statement'}" value="statement" @click="handleChange">
            <div class="item-wrapper"><i class="icon-icon-statement"></i>报表</div>
          </div>   
