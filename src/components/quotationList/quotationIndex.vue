          ...
          <mt-tab-container-item id="1">
            <ul class="qcust-list qmint-region" v-show="hasInsurePoliciesData">
              <li class="qmint-cell" v-for="item in insurePolicies" @click="insListPage(item)">
                <h4 class="qmint-title" style="line-height:22px">
                ...
                <hr width="100%" color="#f5f5f5" size="1" style="padding-top:0.1px;margin:10px 0;" />
                <div v-for="policy in item.policies" style="color:#666;font-size:12px;">
                  <p style="display:flex;align-items:center;font-size:14px;color:#333;height:100%;justify-content: space-between;">
                    <span style="display: flex;align-items: center;">
                      <img :src="policy.src ? policy.src : defaultImg" style="position: absolute;right:90%;width: 20px; height: 20px;">
                      <span style="color:#666;font-size:12px;margin-left:25px;line-height:22px">
          ...
          <mt-tab-container-item id="2">
            <ul class="qcust-list qmint-region" v-show="hasInsurePoliciesData">
              <li class="qmint-cell" v-for="item in insurePolicies" @click="insListPage(item)">
                ...
                <p style="color:#666;font-size:12px">VIN: {{item.vin}}</p>
                <p style="color:#666;font-size:12px">投保人: {{item.applicantName}}</p>
                <hr width="100%" color="#f5f5f5" size="1" style="padding-top:0.1px;margin:15px 0;" />
                <div v-for="policy in item.policies" style="color:#666;font-size:12px;">
                  <p style="display:flex;align-items:center;font-size:14px;color:#333;height:100%;justify-content: space-between;">
                    <span style="display: flex;align-items: center;">
                      <img :src="policy.src ? policy.src : defaultImg" style="position: absolute;right:90%;width: 20px; height: 20px;">
