            ...
            <div class="CompaniesTypes_body">
              ...
              <div v-show="propertyInsurance">
                ...
                <div style="height: 35px; padding: 10px 5px;">
                  <div class="typeName" :class="{isActive:typeAfterValue.indexOf( item.name )!=-1}" v-for="(item, index) in typeOfpossession" :key="index" @click="selectpossession(item,index)">
                    <p>{{item.name}}</p>
                  </div>
                </div>
