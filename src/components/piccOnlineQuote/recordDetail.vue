  ...
  <div class="home">
    ...
    <footer v-show="policyData.premium">
      <div class="mint-footer fn-clear">
        ...
        <div class="btnItem">
          <van-button type="info" style="margin-right:5px;background-color:#0070D3;color:#FFF;font-size:13px" v-show="policyData.insureStatus == 'VerifiedSuccess'" @click="payPage(policyData.payUrl)">去支付</van-button>
        </div>
      </div>
    </footer>
  </div>
...
import quoteData from '../../../static/unwritData.json'
export default {
  name: 'quotedetail',
  data() {
    return {
