    ...
    <div class="wrap-content">
      ...
      <div class="my-info" @click="openModifyPWD">
        <mt-cell title="密码" is-link>
          <span style="color:#0070D3;font-size:13px">修改</span>
        </mt-cell>
      </div>
      <mt-button  type="primary" size="large" @click="Signout">退出登录</mt-button>
...
export default {
  ...
  methods: {
    ...
    Signout: function() {
      ...
      localStorage.removeItem('homeApp');
      sessionStorage.removeItem('cid');
      sessionStorage.removeItem('insuranceNameCode');
