  ...
  <div class="bg">
    <div class="contents">
      ...
      <div class="font">
        ...
        <br>
        <br>
        <div style="color:#F7E359;font-size:14px">温馨提示:<br>注册信息已提交，审核后即可使用<br>账号是您的手机号，密码是证件号后6位</div>
      </div>
      <div class="btn">
        <!-- <van-button class="primary" @click='go' size="large" type="primary" v-show='hasData'>立即下载APP</van-button> -->
        <van-button class="primary" @click='go' size="large" type="primary">去登录</van-button>
      </div>
    </div>
  </div>
</template>
